...
1. delete data where "ground truth == 0" but "predict == 2 or 3 or 4"
2. delete data where "ground truth == 1" but "predict == 2 or 3 or 4"
...
df_res0_del = df_res0[(df_res0['dr_level'] == 3)|(df_res0['dr_level'] == 4)]
df_res1_del = df_res1[(df_res1['dr_level'] == 3)|(df_res1['dr_level'] == 4)]
df_res2_del = df_res2[(df_res2['dr_level'] == 3)|(df_res2['dr_level'] == 4)]
